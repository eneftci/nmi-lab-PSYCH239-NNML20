...
window.RevealExternal = window.RevealExternal || {
    id: 'RevealExternal',
    init: function(deck) {
        initExternal(deck);
    },
    condition: function() {return !!document.querySelector( '[data-external],[data-external-replace]' );}, 
};

const initExternal = function(Reveal){
